...
import RecImage from "../assets/Recipe.svg";
import Cook from "../assets/carouselImage.svg";
...
function BaseCategories({ categoryId }) {
    ...
    React.useEffect(() => {
        axios.get(`https://berecipedjango-production.up.railway.app/all_categories`)
            .then((response) => {
